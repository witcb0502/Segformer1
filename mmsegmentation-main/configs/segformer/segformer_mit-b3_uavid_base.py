...
default_hooks = dict(
    ...
    checkpoint=dict(
        ...
        save_last=True,
        rule='greater',
        out_dir='./work_dirs/segformer_b3_uavid/checkpoints'  # 修改checkpoint保存路径
    )
)
...
work_dir = './work_dirs/segformer_b3_uavid'
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='TensorBoardLoggerHook', log_dir='./work_dirs/segformer_b3_uavid/tensorboard_logs')  # TensorBoard日志
    ]
)